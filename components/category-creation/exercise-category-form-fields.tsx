...
interface ExerciseCategoryFormFieldsProps {
  form: UseFormReturn<ExerciseCategoryFormData>;
  disabled?: boolean;
}

export function ExerciseCategoryFormFields({ form, disabled = false }: ExerciseCategoryFormFieldsProps) {
  const {
    register,
    setValue,
    watch,
    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          <Input
            id="category-name"
            placeholder="Nhập tên danh mục bài tập"
            {...register('name', {
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          placeholder="Nhập mô tả danh mục bài tập (tùy chọn)"

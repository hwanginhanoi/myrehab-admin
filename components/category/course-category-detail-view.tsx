...
import { getCourseCategoryTypeLabel } from '@/lib/utils/course-category';
import { formatDate } from '@/lib/utils/date';

interface CourseCategoryDetailViewProps {
  category: CourseCategoryResponse;
  onEdit: () => void;
}

export function CourseCategoryDetailView({ category, onEdit }: CourseCategoryDetailViewProps) {
  return (
    <>
      {/* Header Section */}
      <div className="flex items-end justify-between mb-6">
        <div className="space-y-2">
          <p className="text-base font-bold text-[#939598]">Danh mục lộ trình</p>
        ...
        <div className="w-[556px]">
          <div className="space-y-1.5">
            ...
            <p className="text-base font-medium text-[#020617]">
              {getCourseCategoryTypeLabel(category.type)}
            </p>
          </div>
        </div>

        ...
        <Card>
          <CardContent className="pt-6">
            <div className="text-center py-8">
              ...
              <Button onClick={() => router.push('/dashboard/custom-courses')}>
    ...
    <div className="flex flex-1 flex-col">
      <div className="m-9 mt-9 mb-6">
        ...
        <div className="mb-6">
          <Button
            variant="outline"
            onClick={() => router.push('/dashboard/custom-courses')}
        ...
        <div className="space-y-6">
          ...
          <div className="flex items-end justify-between py-6">
            ...
            <div>
              <Button
                onClick={() => router.push(`/dashboard/custom-courses/${course.id}/edit`)}

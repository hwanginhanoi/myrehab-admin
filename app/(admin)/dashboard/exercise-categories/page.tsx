...
const columnHelper = createColumnHelper<ExerciseCategoryResponse>();

// Vietnamese translations for exercise category types
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              <DropdownMenuItem
                onClick={() => {
                  if (category.id) {
                    router.push(`/dashboard/exercise-categories/${category.id}`);
                  }
                }}
              >
              ...
              <DropdownMenuItem
                onClick={() => {
                  if (category.id) {
                    router.push(`/dashboard/exercise-categories/${category.id}/edit`);
                  }
                }}
              >
    ...
    <div className="flex flex-1 flex-col">
      ...
      <div className="m-9 mt-9 mb-6">
            ...
            <div className="flex items-center justify-between mb-6">
              <div>
                <h1 className="text-4xl font-bold text-[#EF7F26] mb-2">Danh mục bài tập</h1>
              ...
              <Button
                ...
                onClick={() => router.push('/dashboard/exercise-categories/create')}
              >
            ...
            <div className="flex items-center gap-4 mb-6">
              <div className="flex-1 max-w-md">
                <Input
                  type="text"
                  placeholder="Tìm kiếm danh mục bài tập..."
                  className="w-full"
                />
              </div>
              <div className="w-48">

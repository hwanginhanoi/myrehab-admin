...
import { myTrainersColumns } from './my-trainers-columns'
import { MyTrainersTableToolbar } from './my-trainers-table-toolbar'

type MyTrainersTableProps = {
  data: StaffResponse[]
...
export function MyTrainersTable({
  data,
  search,
  navigate,
  pageCount,
}: MyTrainersTableProps) {

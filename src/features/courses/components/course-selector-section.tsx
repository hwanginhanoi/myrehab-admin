...
import { useGetMyPatients, type UserResponse } from '@/api'
...
export function CourseSelectorSection({
  ...
  const { data: patientsResponse, isLoading: isLoadingPatients } =
    useGetMyPatients({
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Tìm và chọn bệnh nhân để tạo khóa học
            </CardDescription>
          </CardHeader>
          <CardContent>
            {isLoadingPatients ? (
          ...
          <CardContent className="space-y-4">
            ...
            <div className="pt-4">
              <Button
                ...
                disabled={
                  !numberOfDays || numberOfDays < 1 || !courseName.trim()
                }
                className="w-full"
              >

...
import { rehabilitationFormsColumns as columns } from './rehabilitation-forms-columns'
import { RehabilitationFormsTableToolbar } from './rehabilitation-forms-table-toolbar'

type DataTableProps = {
  data: RehabilitationExaminationFormResponse[]

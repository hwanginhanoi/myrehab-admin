...
import { myPatientsColumns } from './my-patients-columns'
import { MyPatientsTableToolbar } from './my-patients-table-toolbar'

type MyPatientsTableProps = {
  data: DoctorPatientResponse[]
...
export function MyPatientsTable({
  ...
  return (
    ...
    >
      <MyPatientsTableToolbar table={table} />

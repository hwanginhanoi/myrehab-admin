 ...
 * @description OK
 */
export const getNationalInsurance200Schema = z.lazy(() => nationalHealthInsuranceResponseSchema)

export const getNationalInsuranceQueryResponseSchema = z.lazy(() => getNationalInsurance200Schema)
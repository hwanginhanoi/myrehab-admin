...
export const loginWithPinMutationRequestSchema = z.lazy(() => loginWithPinRequestSchema)

export const loginWithPinMutationResponseSchema = z.lazy(() => loginWithPin200Schema)
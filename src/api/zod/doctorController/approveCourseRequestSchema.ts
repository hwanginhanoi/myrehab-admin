 ...
 * @description OK
 */
export const approveCourseRequest200Schema = z.lazy(
  () => courseAssignmentRequestResponseSchema,
);

export const approveCourseRequestMutationRequestSchema = z.lazy(
  () => reviewCourseRequestRequestSchema,
);

export const approveCourseRequestMutationResponseSchema = z.lazy(

...
export { assignTrainerToDoctorPathParamsSchema, assignTrainerToDoctor200Schema, assignTrainerToDoctorMutationResponseSchema } from "./assignTrainerToDoctorSchema.ts";

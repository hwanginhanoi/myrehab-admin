 ...
 * @description OK
 */
export const getAvailableSlots200Schema = z.array(z.lazy(() => availableSlotResponseSchema))

export const getAvailableSlotsQueryResponseSchema = z.lazy(() => getAvailableSlots200Schema)
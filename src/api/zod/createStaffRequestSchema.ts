...
export const createStaffRequestSchema = z
  .object({
    ...
    password: z
      ...
      .min(8)
      .max(2147483647)
      .describe('Staff password (min 8 characters)'),
    ...
    staffType: z
      ...
      .describe('Type of staff to create'),
    description: z.optional(z.string().describe('Staff description or bio')),
    permissions: z.optional(
      z
        .array(z.string())
        .describe('List of permission codes assigned to this staff member')
    ),
    isPublic: z.optional(
      z
        .boolean()
        .describe(
          'Whether this doctor is visible in the mobile app. Only applies to DOCTOR type.'
        )
    ),
  })

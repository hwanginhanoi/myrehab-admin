 ...
 * {@link /api/exercise-packages}
 */
export function useGetAllExercisePackages<
  TData = GetAllExercisePackagesQueryResponse,
  TQueryData = GetAllExercisePackagesQueryResponse,
  TQueryKey extends QueryKey = GetAllExercisePackagesQueryKey,
>(
  params: GetAllExercisePackagesQueryParams,
  options: {
    query?: Partial<

...
export async function loginWithPassword(data: LoginWithPasswordMutationRequest, config: Partial<RequestConfig<LoginWithPasswordMutationRequest>> & { client?: typeof fetch } = {}) {
  ...
  const res = await request<LoginWithPasswordMutationResponse, ResponseErrorConfig<Error>, LoginWithPasswordMutationRequest>({ method : "POST", url : `/api/auth/staff/login`, data : requestData, ... requestConfig })  
  return res.data
}

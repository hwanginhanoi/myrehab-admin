...
export const getAllNewsQueryKey = (params: GetAllNewsQueryParams) =>
...
export function useGetAllNews<
  TData = GetAllNewsQueryResponse,
  TQueryData = GetAllNewsQueryResponse,
  TQueryKey extends QueryKey = GetAllNewsQueryKey,
>(
  params: GetAllNewsQueryParams,
  options: {
    query?: Partial<

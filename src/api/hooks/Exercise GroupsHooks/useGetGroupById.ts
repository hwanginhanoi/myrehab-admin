 ...
 * {@link /api/exercise-groups/:id}
 */
export function useGetGroupById<TData = GetGroupByIdQueryResponse, TQueryData = GetGroupByIdQueryResponse, TQueryKey extends QueryKey = GetGroupByIdQueryKey>(id: GetGroupByIdPathParams["id"], options: 
{
  query?: Partial<QueryObserverOptions<GetGroupByIdQueryResponse, ResponseErrorConfig<Error>, TData, TQueryData, TQueryKey>> & { client?: QueryClient },

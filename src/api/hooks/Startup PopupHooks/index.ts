...
export type { DeletePopupMutationKey } from './useDeletePopup.ts'
...
export { deletePopupMutationKey } from './useDeletePopup.ts'
export { deletePopup } from './useDeletePopup.ts'
export { deletePopupMutationOptions } from './useDeletePopup.ts'
export { useDeletePopup } from './useDeletePopup.ts'

 ...
 * {@link /api/appointments/admin/disputed}
 */
export function useGetDisputedAppointments<
  TData = GetDisputedAppointmentsQueryResponse,
  TQueryData = GetDisputedAppointmentsQueryResponse,
  TQueryKey extends QueryKey = GetDisputedAppointmentsQueryKey,
>(
  params: GetDisputedAppointmentsQueryParams,
  options: {
    query?: Partial<

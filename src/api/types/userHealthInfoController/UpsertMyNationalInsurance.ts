...
export type UpsertMyNationalInsuranceMutationRequest = UpsertNationalHealthInsuranceRequest;

export type UpsertMyNationalInsuranceMutationResponse = UpsertMyNationalInsurance200;

 ...
 * @description OK
*/
export type UpsertMyNonCompulsoryInsurance200 = NonCompulsoryHealthInsuranceResponse;

export type UpsertMyNonCompulsoryInsuranceMutationRequest = UpsertNonCompulsoryHealthInsuranceRequest;

export type UpsertMyNonCompulsoryInsuranceMutationResponse = UpsertMyNonCompulsoryInsurance200;

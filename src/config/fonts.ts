 ...
 * This array is used to generate dynamic font classes (e.g., `font-inter`, `font-manrope`, `font-comfortaa`).
 *
 ...
 *   }
 */
export const fonts = ['inter', 'manrope', 'comfortaa', 'system'] as const

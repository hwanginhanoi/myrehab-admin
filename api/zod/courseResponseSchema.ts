...
export const courseResponseSchema = z.object({ "id": z.number().int().optional(), "title": z.string().optional(), "description": z.string().optional(), "imageUrl": z.string().optional(), "price": z.number().optional(), "durationDays": z.number().int().optional(), "isActive": z.boolean().optional(), "category": z.lazy(() => categoryResponseSchema).optional(), "courseDays": z.array(z.lazy(() => courseDayResponseSchema)).optional(), "createdAt": z.string().datetime().optional(), "updatedAt": z.string().datetime().optional() });